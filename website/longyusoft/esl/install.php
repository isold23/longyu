...
`blog_language` 	varchar(8) 	NOT NULL,
	...
	/*	$data="INSERT INTO $user (`id`,`name`,`password`,
		`email`,`group_id`,`reg_time`,`last_time`,
		`reg_ip`,`last_ip`) VALUES ( '1','".$admin_user."','".md5($admin_pass)."',
		'isold_wang@yahoo.com.cn','1','".$time."','".$time."','','');
";
	$db1->query($data);
	*/
	
	$group_table=$dbprefix.'user_group';
	...
	/*	$data="INSERT INTO $user_group (`id`,`name`,`rights` ) VALUES ( '1','Admin','99999'),('2','注册会员','9'),('3','游客','');
";
	$db1->query($data);
*/
	/*$blog_table=$dbprefix.'blog';
