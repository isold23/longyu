<?php /* Smarty version 2.6.22, created on 2011-09-15 21:01:30
...
?>
                <div id="message_item">
                    ...
                    <div id="message_item_author">
                            <p><?php echo $this->_tpl_vars['author']; ?>
: <?php echo $this->_tpl_vars['message']['user_name']; ?>
 <?php echo $this->_tpl_vars['post_time']; ?>
: <?php echo $this->_tpl_vars['message']['post_time']; ?>
</p>
                    </div>
                </div>
            ...
            <div id="post_message">
                    ...
                    <h1 class="unit_header">
                        <?php echo $this->_tpl_vars['post_message']; ?>
</h1>
                </div>
                <div class="unit-body">
...
: <?php echo $this->_tpl_vars['user_name']; ?>
                  ...
                  <?php endif; ?>
                    ...
                    <p>
                        <input type="submit" name="button" id="button" value="<?php echo $this->_tpl_vars['post']; ?>
" />
                    </p>
                </div>
              </div>
