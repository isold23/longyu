...
function admin_here($type)
{
	...
	elseif ($type=='add_online_cat')
	{
		$admin_here= '添加在线分类';
		$admin_title='添加在线分类';
	}
	elseif ($type=='edit_online_cat')
	{
		$admin_here= '编辑在线分类';
		$admin_title='编辑在线分类';
	}
	elseif ($type=='online_cat_list')
	{
		$admin_here= '在线分类列表';
		$admin_title='在线分类列表';
	}
	elseif ($type=='add_online_resource')
	{
		$admin_here= '添加在线资源';
		$admin_title='添加在线资源';
	}
	elseif ($type=='edit_online_resource')
	{
		$admin_here= '编辑在线资源';
		$admin_title='编辑在线资源';
	}
	elseif ($type=='online_resource_list')
	{
		$admin_here= '在线资源列表';
		$admin_title='在线资源列表';
	}
		elseif ($type=='add_online_small_cat')
	{
		$admin_here= '添加在线子分类';
		$admin_title='添加在线子分类';
	}
	elseif ($type=='edit_online_small_cat')
	{
		$admin_here= '编辑在线子分类';
		$admin_title='编辑在线子分类';
	}
	elseif ($type=='online_small_cat_list')
	{
		$admin_here= '在线子分类列表';
		$admin_title='在线子分类列表';
	}
