...
elseif ($action=='act_add_blog')
{
	...
	" (`id` ,`user_id` ,`cat_id` ,`title` ,`description` ,`content` ,`post_time` ,`last_time` ,`comment_count` ,`view_count` ,`password`,`view_group`,`open_type`,`url_type` )
...
elseif ($action=='act_edit_blog')
{
	...
	"' , `last_time`='".$time."', `cat_id`='".$cat_id."' , `password`='".$password."' , `open_type`='".$open_type."' , `view_group`='".$group."' , `url_type`='".$url_type.
	"' WHERE id='".$blog_id."'";
