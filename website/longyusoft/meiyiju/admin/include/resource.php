...
elseif ($action=='act_add_resource')
{
	...
	" (`id` ,`user_id` ,`cat_id` ,`name` ,`number` ,`spec` ,`upload_time` ,`origin` ,`material` ,`weight` ,`price` ,`image_path`,`remark` )
...
elseif ($action=='act_edit_resource')
{
	...
	"' ,`remark`='".$resource_remark."',`image_path`='".$resource_image_path."', `upload_time`='".$time."', `cat_id`='".$cat_id."' ,`origin`='".$resource_origin."' , `material`='".$resource_material."' , `weight`='".$resource_weight."' , `price`='".$resource_price.
