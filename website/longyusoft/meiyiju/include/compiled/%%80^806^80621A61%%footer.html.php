<?php /* Smarty version 2.6.22, created on 2011-07-16 13:46:05
...
<div id="footer">
    <div id="footer-content">
        <div id="footer-item">
            Copyright 版权所有 2009-2011 <a href="<?php echo $this->_tpl_vars['web_url']; ?>
" target="_parent"><?php echo $this->_tpl_vars['web_name']; ?>
 ...
 <?php echo $this->_tpl_vars['web_domain']; ?>
        	...
        	技术支持 <a href="http://www.longyusoft.com/about.php" target="_parent">北京龙宇软件工作室</a>
        </div>
       <div id="footer-item">
            建议使用IE8及以上版本IE浏览器、火狐、谷歌浏览器浏览网站
        </div>
    </div>
    <!--end footer-content-->
</div>
