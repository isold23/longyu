		...
		<div id="page-header">
			<div id = "header-login">
				<div id = "login">
					...
					{
						$output='<a href="#logindialog" name="modal">登录</a>';
					}
					else
					{
						$output='<a href="user.php?act=logout">登出</a>';
					}
					?>
					&nbsp
					<a href="#regdialog" name="modal">注册</a>
					&nbsp
					<a href="">帮助</a>
				</div>
			</div>
		  ...
		  <li><a href="blog.php">博客</a>
		    <ul>
		    <li><a href="blog.php">博客首页</a></li>
		    <li><a href="blog.php">推荐日志</a></li>
		    <li><a href="blog.php">留言簿</a></li>
		    </ul>
		  </li>
		  <li><a href="baby.php">家有宝贝</a></li>
		  <li><a href="#">龙宇软件</a></li>
		  <li><a href="daily.php">成长日记</a></li>
		  <li><a href="resourcedownload.php">资料下载</a></li>
...
<div id="logindialog" class="window">
 ...
 <p>密码：<br />
   ...
   <p>
   <input name="safe_url" type="hidden" value="{$safe_url}" /> <input type="submit" name="button" id="button" value="登录" />
  </p>
	</div>
	</form>
</div>
