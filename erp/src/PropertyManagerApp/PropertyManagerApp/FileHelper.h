...
namespace Fh
{
	...
	////////////////////////////////////////////////////////////////////////
	CString GetFileExt(LPCTSTR pcszFilePath,BOOL bWithDot = FALSE);
	...
	{
	public:
		Cder(LPCTSTR pcszDir) {
			::GetCurrentDirectory(MAX_PATH,m_initDir);
			::SetCurrentDirectory(pcszDir);
		}

		~Cder(void) {
			::SetCurrentDirectory(m_initDir);
		}
