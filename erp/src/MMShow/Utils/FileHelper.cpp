...
////////////////////////////////////////////////////////////////////////
CString GetFileExt(LPCTSTR pcszFilePath,BOOL bWithDot)
{
	LPCTSTR pcszDot = _tcsrchr((LPCTSTR)pcszFilePath,_T('.'));
	return (pcszDot == NULL ? CString() : bWithDot? pcszDot : pcszDot + 1); 	
}
...
////////////////////////////////////////////////////////////////////////
// Function: To app directory
// Params:
//      LPCTSTR pcszFileName : name of the file to convert
////////////////////////////////////////////////////////////////////////
CString ToAppDirectory(LPCTSTR pcszFileName)
{
	TCHAR szMoudlePath[MAX_PATH];
	::GetModuleFileName(NULL,szMoudlePath,_countof(szMoudlePath));
	LPTSTR pSlash = (LPTSTR)RFindPathSlash(szMoudlePath);
	if (IsSlash(*pcszFileName))
		pcszFileName += 1;
	_tcscpy(pSlash+1,pcszFileName);
	return szMoudlePath;
}


////////////////////////////////////////////////////////////////////////
// Function: Set current directory to app directory
////////////////////////////////////////////////////////////////////////
BOOL CdAppDirectory(void)
{
	TCHAR szMoudlePath[MAX_PATH];
	::GetModuleFileName(NULL,szMoudlePath,_countof(szMoudlePath));
	LPTSTR pSlash = (LPTSTR)RFindPathSlash(szMoudlePath);
	*pSlash = _T('\0');
	...
	return SetCurrentDirectory(szMoudlePath);
}
