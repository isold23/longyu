...
public:
	...
	// use wchar sql sting
	BOOL Open(_ConnectionPtr mpdb, wchar_t *pwszExec, int nOption = CADORecordset::openUnknown);
	...
	// use get wchar fieldvalue
	BOOL GetFieldValue(LPCTSTR lpFieldName, wchar_t *pwszValue, CString strDateFormat = _T(""));
	...
	BOOL GetChunk(LPCTSTR lpFieldName, LPCTSTR lpFilePath);
...
public:
	...
	long GetFieldContentSize(LPCTSTR lpField);
